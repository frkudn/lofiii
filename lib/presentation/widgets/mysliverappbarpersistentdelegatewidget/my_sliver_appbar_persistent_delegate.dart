...
class MySliverAppBarPersistentDelegate extends SliverPersistentHeaderDelegate {
  MySliverAppBarPersistentDelegate({required this.imageUrl, required this.artistName});
          ...
          Padding(
            ...
            child: Align(
                ...
                child: Text(
                  ...
                  style:
                  TextStyle(color: Colors.white, fontSize: 25.sp,shadows: [const Shadow(color: Colors.black38,blurRadius: 5,)]),
                )),
          ),
        ],
      ),
