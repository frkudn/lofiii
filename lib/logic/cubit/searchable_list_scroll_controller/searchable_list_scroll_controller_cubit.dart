...
class SearchableListScrollControllerCubit
    extends Cubit<SearchableListScrollControllerState> {
  SearchableListScrollControllerCubit()
      : super(const SearchableListScrollControllerState(scrollOffset: 0));
