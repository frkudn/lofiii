...
import '../../../../common/glass_button_widget.dart';

class OnlinePlayerScreenBackSectionWidget extends StatelessWidget {
  const OnlinePlayerScreenBackSectionWidget({
    super.key,
  });
        ...
        child: Stack(
          children: [
            ...
            BlocBuilder<NowPlayingMusicDataToPlayerCubit,
              ...
              builder: (context, nowPlayingMusicDataState) {
